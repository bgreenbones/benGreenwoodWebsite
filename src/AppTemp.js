...
//   if (text == " ") return text;
//   const tooltipStyle = 'padding:5px 5px 5px 5px; max-width: 200px; font-family: Arial;';
...
//     ["software engineer", "software engineer", 3, "I was able to keep up some tech activities while doing the music master's:" +
